...
function initAdminAuth() {
  ...
  const autoFillBtn = document.getElementById('\x61\x75\x74\x6f\x46\x69\x6c\x6c\x41\x64\x6d\x69\x6e\x42\x74\x6e');
  if (autoFillBtn) {
    autoFillBtn.addEventListener('\x63\x6c\x69\x63\x6b', () => {
      const emailInput = document.getElementById('\x61\x64\x6d\x69\x6e\x45\x6d\x61\x69\x6c');
      const passInput = document.getElementById('\x61\x64\x6d\x69\x6e\x50\x61\x73\x73\x77\x6f\x72\x64');
      if (emailInput) emailInput.value = FIXED_ADMIN_EMAIL;
      if (passInput) passInput.value = FIXED_ADMIN_PASS;
      if (errorMsg) errorMsg.style.display = '\x6e\x6f\x6e\x65';
      toast('\x46\x69\x78\x65\x64\x20\x63\x72\x65\x64\x65\x6e\x74\x69\x61\x6c\x73\x20\x66\x69\x6c\x6c\x65\x64', '\x63\x68\x65\x63\x6b');
    });
  }
  try {
    const params = new URLSearchParams(window.location.search);
    const urlEmail = (params.get('\x61\x64\x6d\x69\x6e\x45\x6d\x61\x69\x6c') || '').trim().toLowerCase();
    const urlPass = (params.get('\x61\x64\x6d\x69\x6e\x50\x61\x73\x73\x77\x6f\x72\x64') || '').trim();
    if (urlEmail && urlPass) {
      if ((urlEmail === FIXED_ADMIN_EMAIL || urlEmail === '\x61\x64\x6d\x69\x6e\x40\x6d\x6f\x62\x69\x65\x67\x61\x6c\x6c\x65\x72\x79\x2e\x63\x6f\x6d') && urlPass === FIXED_ADMIN_PASS) {
  ...
  if (loginForm) {
    loginForm.addEventListener('\x73\x75\x62\x6d\x69\x74', e => {
      ...
      const isEmailValid = (email === FIXED_ADMIN_EMAIL || email === '\x61\x64\x6d\x69\x6e\x40\x6d\x6f\x62\x69\x65\x67\x61\x6c\x6c\x65\x72\x79\x2e\x63\x6f\x6d');
      const isPassValid = (pass === FIXED_ADMIN_PASS);
      if (isEmailValid && isPassValid) {
        ...
        if (errorMsg) {
          errorMsg.textContent = '';
          errorMsg.style.display = '\x62\x6c\x6f\x63\x6b';
        }
        toast('\x49\x6e\x76\x61\x6c\x69\x64\x20\x63\x72\x65\x64\x65\x6e\x74\x69\x61\x6c\x73\x2e\x20\x43\x68\x65\x63\x6b\x20\x47\x6d\x61\x69\x6c\x20\x26\x20\x50\x61\x73\x73\x77\x6f\x72\x64', '\x63\x6c\x6f\x73\x65');
      }
    });
  }
  if (logoutBtn) {
