...
function setAdminLoggedIn(status) {
  try {
    if (status) {
      ...
      let authStyle = document.getElementById('\x61\x64\x6d\x69\x6e\x41\x75\x74\x68\x53\x74\x79\x6c\x65');
      if (!authStyle) {
        authStyle = document.createElement('\x73\x74\x79\x6c\x65');
        authStyle.id = '\x61\x64\x6d\x69\x6e\x41\x75\x74\x68\x53\x74\x79\x6c\x65';
        authStyle.innerHTML = '';
        document.head.appendChild(authStyle);
      }
    } else {
      sessionStorage.removeItem(ADMIN_AUTH_KEY);
      const authStyle = document.getElementById('\x61\x64\x6d\x69\x6e\x41\x75\x74\x68\x53\x74\x79\x6c\x65');
...
function updateAdminView() {
  ...
  if (loginView && dashView) {
    if (loginView.style.setProperty) {
      loginView.style.setProperty('\x64\x69\x73\x70\x6c\x61\x79', loggedIn ? '\x6e\x6f\x6e\x65' : '\x66\x6c\x65\x78', '\x69\x6d\x70\x6f\x72\x74\x61\x6e\x74');
    }
    loginView.style.display = loggedIn ? '\x6e\x6f\x6e\x65' : '\x66\x6c\x65\x78';
    if (dashView.style.setProperty) {
      dashView.style.setProperty('\x64\x69\x73\x70\x6c\x61\x79', loggedIn ? '\x62\x6c\x6f\x63\x6b' : '\x6e\x6f\x6e\x65', '\x69\x6d\x70\x6f\x72\x74\x61\x6e\x74');
    }
    dashView.style.display = loggedIn ? '\x62\x6c\x6f\x63\x6b' : '\x6e\x6f\x6e\x65';
  }
  if (loggedIn) {
    try { paintPreview(); } catch (e) { console.warn('\x70\x61\x69\x6e\x74\x50\x72\x65\x76\x69\x65\x77\x20\x65\x72\x72\x6f\x72\x3a', e); }
    try { renderAdminProductsList(); } catch (e) { console.warn('\x72\x65\x6e\x64\x65\x72\x41\x64\x6d\x69\x6e\x50\x72\x6f\x64\x75\x63\x74\x73\x4c\x69\x73\x74\x20\x65\x72\x72\x6f\x72\x3a', e); }
    try { renderAdminOrdersList(); } catch (e) { console.warn('\x72\x65\x6e\x64\x65\x72\x41\x64\x6d\x69\x6e\x4f\x72\x64\x65\x72\x73\x4c\x69\x73\x74\x20\x65\x72\x72\x6f\x72\x3a', e); }
    try { renderAdminUsersList(); } catch (e) { console.warn('\x72\x65\x6e\x64\x65\x72\x41\x64\x6d\x69\x6e\x55\x73\x65\x72\x73\x4c\x69\x73\x74\x20\x65\x72\x72\x6f\x72\x3a', e); }
    try { updateConnectionPill(); } catch (e) { console.warn('\x75\x70\x64\x61\x74\x65\x43\x6f\x6e\x6e\x65\x63\x74\x69\x6f\x6e\x50\x69\x6c\x6c\x20\x65\x72\x72\x6f\x72\x3a', e); }
  }
}
function initAdminAuth() {
  const loginBtn = document.getElementById('\x61\x64\x6d\x69\x6e\x4c\x6f\x67\x69\x6e\x53\x75\x62\x6d\x69\x74\x42\x74\x6e');
  const logoutBtn = document.getElementById('\x61\x64\x6d\x69\x6e\x4c\x6f\x67\x6f\x75\x74\x42\x74\x6e');
  if (loginBtn) {
    loginBtn.addEventListener('\x63\x6c\x69\x63\x6b', e => {
      e.preventDefault();
      setAdminLoggedIn(true);
      try {
      ...
      if (typeof toast === '\x66\x75\x6e\x63\x74\x69\x6f\x6e') {
        toast('\x57\x65\x6c\x63\x6f\x6d\x65\x20\x74\x6f\x20\x41\x64\x6d\x69\x6e\x20\x50\x6f\x72\x74\x61\x6c', '\x63\x68\x65\x63\x6b\x43\x69\x72\x63\x6c\x65');
      }
    });
  }
